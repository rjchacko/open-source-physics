...
public class InteractionEvent extends ActionEvent {
   ...
   */
  static public final int MOUSE_PRESSED = ActionEvent.RESERVED_ID_MAX+1;

  /**
   * ID for the action of dragging the mouse on the element
   */
  static public final int MOUSE_DRAGGED = ActionEvent.RESERVED_ID_MAX+2;

  /**
   * ID for the action of releasing the mouse on the element
   */
  static public final int MOUSE_RELEASED = ActionEvent.RESERVED_ID_MAX+3;

  /**
   * ID for the action of entering (lingering on) the element
   */
  static public final int MOUSE_ENTERED = ActionEvent.RESERVED_ID_MAX+4;

  /**
   * ID for the action of exiting the element
   */
  static public final int MOUSE_EXITED = ActionEvent.RESERVED_ID_MAX+5;

  /**
   * ID for the action of moving the mouse on the element
   */
  static public final int MOUSE_MOVED = ActionEvent.RESERVED_ID_MAX+6;
  private Object info;
