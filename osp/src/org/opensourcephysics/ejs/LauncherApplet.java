...
public class LauncherApplet extends JApplet {
  ...
  public void init() {
    ...
    if(windowToCapture!=null&&getParentFrame()!=null&&getParentFrame() instanceof java.awt.Frame) {
  ...
  public String[][] getParameterInfo() {
    String[][] pinfo = {
      {"simulation", "String", "The simulation"}, {"capture", "String", "The name of the component to be captured"},
    };
    return pinfo;
  }
