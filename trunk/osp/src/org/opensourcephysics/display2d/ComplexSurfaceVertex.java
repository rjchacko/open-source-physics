 ...
 */
  ...
  public final Point projection() {
    if(project_index!=surface.master_project_indexV) {
      projection = surface.projector.project(x, y, (double) ((z-surface.zminV)*surface.zfactorV-10));
  ...
  public final void transform() {
    ...
    z = (double) ((surface.zmaxV-surface.zminV)*(z/surface.projector.getZScaling()+10)/20+surface.zminV);
  }
}
