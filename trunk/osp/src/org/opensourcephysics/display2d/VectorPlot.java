...
public class VectorPlot implements Plot2D {
  ...
  static GeneralPath createVectorPath(float size) {
    ...
    path.moveTo((float) -size/2, (float) 0);               // start drawing at the base
    path.lineTo((float) size/2, (float) 0);                // line to the tip of the head
    path.lineTo((float) size/2-head, (float) 2.0*head/3);  // draw one side
    path.lineTo((float) size/2, (float) 0);                // back to the tip
    path.lineTo((float) size/2-head, (float) -2.0*head/3); // draw the other side
    return path;
  }
  ...
  static GeneralPath createFilledVectorPath(float size) {
    ...
    path.lineTo((float) size/2-head, (float) 1); // line to base tip of the head
    path.lineTo((float) size/2-head, (float) 2*head/3);  // draw to one side
    path.lineTo((float) size/2, (float) 0);              // up to the tip
    path.lineTo((float) size/2-head, (float) -2*head/3); // the other side
    path.lineTo((float) size/2-head, (float) -1);        // back to base tip of the head
  ...
  ; // set to true if the measure is valid.
