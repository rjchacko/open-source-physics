...
public class ComplexDataset extends AbstractTableModel implements Drawable, Measurable, Data {
  ...
  private String xColumnName="x";  // the name of the x data
  private String reColumnName="re"; // the name of the y data
  private String imColumnName="im"; // the name of the y data
  ...
  public JFrame showLegend() {
     ...
     DrawingFrame frame = new DrawingFrame("Phase Legend",panel);
     frame.setJMenuBar(null);
     panel.addDrawable(new Phase());
     XAxis xaxis = new XAxis("phase angle (rad)");
...
*/
  ...
  public void setXYColumnNames(String _xColumnName, String _reColumnName, String _imColumnName, String datasetName) {
	  ...
	  name=GUIUtils.parseTeX(datasetName);
  }
  ...
  public void append(double[] _xpoints, double[] _repoints, double[] _impoints) {
    ...
    if(pointsAdded>availableSpots) {
      setCapacity(xpoints.length+pointsAdded); // FIX ME
    }
  ...
  public void append(double[] _xpoints, double[] _zpoints) {
    ...
    int availableSpots = xpoints.length-index;
    if(pointsAdded>availableSpots) {
      setCapacity(xpoints.length+pointsAdded); // fix
    }
    for(int i = 0;i<_xpoints.length;i++) {
...
*/
  public static XML.ObjectLoader getLoader() {
   ...
   public ArrayList getDatasets(){
      ...
      reDataset.clear();
      imDataset.clear();
      reDataset.setXYColumnNames(xColumnName,reColumnName,"Re("+name+")");
      imDataset.setXYColumnNames(xColumnName,imColumnName,"Im("+name+")");
