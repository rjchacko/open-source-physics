...
public class MethodWithOneParameter {
  ...
  MethodWithOneParameter(int _type, Object _target, String _name, String _returnType, MethodWithOneParameter _secondMethod, Object _anObject) {
    ...
    if(parts[2].equals("#CONTROL#")&&_anObject!=null) {
      parameter = _anObject;
      ...
      if(value==null) {
        parameter = null;                                 // format is 'method' or format 'method()' or 'method(parameter)'
      } else if(value instanceof StringValue) {  // method ("String")
    ...
    if(methodToCall==null) {
      System.err.println(getClass().getName()+" : Error! Unable to find a suitable method "+methodName+" in class "+targetObject.getClass().getName());
    }
    if(_returnType==null) {
