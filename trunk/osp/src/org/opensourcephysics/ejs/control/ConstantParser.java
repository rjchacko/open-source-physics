...
public class ConstantParser {
  ...
  static public Value colorConstant(String _value) {
    ...
    if(_value.equals("null")||_value.equals("none")) {
      return new ObjectValue(NULL_COLOR);
    }
    if(_value.equals("black")||_value.equals("Color.black")) {
      return new ObjectValue(Color.black);
    }
    if(_value.equals("blue")||_value.equals("Color.blue")) {
      return new ObjectValue(Color.blue);
    }
    if(_value.equals("cyan")||_value.equals("Color.cyan")) {
      return new ObjectValue(Color.cyan);
    }
    if(_value.equals("darkGray")||_value.equals("Color.darkGray")) {
      return new ObjectValue(Color.darkGray);
    }
    if(_value.equals("gray")||_value.equals("Color.gray")) {
      return new ObjectValue(Color.gray);
    }
    if(_value.equals("green")||_value.equals("Color.green")) {
      return new ObjectValue(Color.green);
    }
    if(_value.equals("lightGray")||_value.equals("Color.lightGray")) {
      return new ObjectValue(Color.lightGray);
    }
    if(_value.equals("magenta")||_value.equals("Color.magenta")) {
      return new ObjectValue(Color.magenta);
    }
    if(_value.equals("orange")||_value.equals("Color.orange")) {
      return new ObjectValue(Color.orange);
    }
    if(_value.equals("pink")||_value.equals("Color.pink")) {
      return new ObjectValue(Color.pink);
    }
    if(_value.equals("red")||_value.equals("Color.red")) {
      return new ObjectValue(Color.red);
    }
    if(_value.equals("white")||_value.equals("Color.white")) {
      return new ObjectValue(Color.white);
    }
    if(_value.equals("yellow")||_value.equals("Color.yellow")) {
  ...
  static public Value formatConstant(String _value) {
    if(_value.indexOf(";")==-1) { // FKH 021103
      ...
      if(id>0) {
        _value = _value+";"+_value.substring(0, id)+"-"+_value.substring(id);
      }
    }                             // endFKH 021103
    try {
