...
public abstract class ControlElement {
  ...
  public ControlElement setProperty(String _property, String _value) {
    ...
    if(constantValue!=null) { // Just set the value for this property
      ...
      if((constantValue instanceof StringValue)&&propertyIsTypeOf(_property, "TRANSLATABLE") // Apply Translator
        &&(OSPRuntime.translator!=null)) {                                                   // added by D Brown 2007-10-17
        Object target = null;
        if(myGroup!=null) {
          target = myGroup.getTarget("_default_");
        }
      ...
      if(myGroup!=null) {
        ...
        if(isNormalVariable) {      // Connect a variable property with a normal variable name
          ...
          if(propertyIsTypeOf(_property, "double")) {
            ...
            System.out.println("Error for property "+_property+" of the element "+this.toString()
