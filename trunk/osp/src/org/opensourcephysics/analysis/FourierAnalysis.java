   ...
   public java.util.ArrayList getComplexDatasets() {
     java.util.ArrayList list = new java.util.ArrayList();
      ...
      if(complexDatasets[0]==null) {
         ...
         complexDatasets[0].setXYColumnNames("frequency","re","im");
      } else {
   ...
   public java.util.ArrayList getDatasets() {
     java.util.ArrayList list = new java.util.ArrayList();
      ...
      if(realDatasets[0]==null) {
         ...
         realDatasets[0].setXYColumnNames("frequency","re","Real Coefficients");
         realDatasets[0].setLineColor(Color.RED);
         realDatasets[1] = new Dataset();
         realDatasets[1].setXYColumnNames("frequency","im","Imaginary Coefficients");
